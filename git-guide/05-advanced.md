...
**Visual learner?** Check [Visual Guide: Rebasing](09-visual-guide.md#rebasing) to see how commits are replayed.
...
**Visual learner?** Check [Visual Guide: Cherry-Pick](09-visual-guide.md#cherry-pick) to see the commit graph.
...
Ready to collaborate with your team? Jump to [Collaboration Patterns](06-collaboration.md).

Or dive into [Fixing Mistakes](07-troubleshooting.md) for disaster recovery.
