...
See [Branching & Merging](04-branching.md) for detailed resolution.
...
Check out [Command Reference](08-reference.md) for a full command lookup.

Or go back to [Advanced Features](05-advanced.md) to learn techniques for preventing mistakes.
